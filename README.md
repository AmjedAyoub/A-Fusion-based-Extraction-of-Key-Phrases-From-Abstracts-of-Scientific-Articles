...
#### Assistant Professor
The main objective of this research is to extract keywords from documents using a fusionbased technique, which is based on three other existing techniques that use “Hulth 2003” as a dataset for training and testing. 
